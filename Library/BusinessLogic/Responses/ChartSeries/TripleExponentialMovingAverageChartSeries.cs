...
{
    public class TripleExponentialMovingAverageChartSeries : ChartSeries
    {
        #region Constructors

        public TripleExponentialMovingAverageChartSeries(string name, string color, IEnumerable<LineSeriesDataPoint> data) : base()
        {
            this.Name = name;
