...
{
    public class VolumeExponentialMovingAverageChartSeries : ChartSeries
    {
        public VolumeExponentialMovingAverageChartSeries(string name, string color, IEnumerable<LineSeriesDataPoint> data) : base()
        {
            this.Name = name;
